...
namespace BLADE.TCPFORTRESS.CoreNET.DB
{
    ...
    [Serializable]
    public class TFS_Address_DBT : BLADE.TOOLS.DBO.DBCODER.DBOP.DBTBASE
    {
        ...
        public static TFS_Address_DBT[] SelectByWhere(int topnum, string wherestr ,BLADE.TOOLS.DBO.DBCODER.DBOP.SQL_Pams Ps)
        {
            TFS_Address_DBT to = new TFS_Address_DBT();
            TFS_Address_DBT[] nay = new TFS_Address_DBT[0];
            BLADE.TOOLS.DBO.DBCODER.DBOP.DBB b = new BLADE.TOOLS.DBO.DBCODER.DBOP.DBB(DefaultConnStr);
    ...
    [Serializable]
    public class TFS_LOGS_DBT : BLADE.TOOLS.DBO.DBCODER.DBOP.DBTBASE
    {
        public TFS_LOGS_DBT()
        ...
        public static TFS_LOGS_DBT[] SelectByWhere(int topnum, string wherestr ,BLADE.TOOLS.DBO.DBCODER.DBOP.SQL_Pams Ps)
        {
